...
module id_ex(
    ...
    input wire[`RegBus] reg3_rdata_i,   //Added for custom mac
    ...
    output wire[`MemAddrBus] op3_o,  // Added for custom mac
    ...
    output wire[`RegBus] reg3_rdata_o,       // Added for custom mac
    ...
    wire[`RegBus] reg3_rdata;
    gen_pipe_dff #(32) reg3_rdata_ff(clk, rst, hold_en, `ZeroWord, reg3_rdata_i, reg3_rdata);
    assign reg3_rdata_o = reg3_rdata;
