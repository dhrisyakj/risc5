...
module tinyriscv(
   ...
   wire[`RegBus] ie_acc_out_o;    // Custom Instruction -MAC
    ...
    wire[`RegAddrBus] id_reg3_raddr_o;  // Custom Instruction -LOAD MAC
    wire[`InstBus] id_inst_o;
    wire[`InstAddrBus] id_inst_addr_o;
    wire[`RegBus] id_reg1_rdata_o;
    wire[`RegBus] id_reg2_rdata_o;
    wire[`RegBus] id_reg3_rdata_o; // Custom Instruction -LOAD MAC
    wire id_reg_we_o;
    ...
    wire[`RegBus] ie_reg2_rdata_o;
     wire[`RegBus] ie_reg3_rdata_o;  // Custom Instruction -LOAD MAC
    wire ie_csr_we_o;
   ...
   wire ie_is_macl_o;  // Custom Instruction -LOAD MAC
    ...
    wire[`RegBus] regs_rdata3_o; // Custom Instruction -LOAD MAC
  ...
  /*
    ...
    regs u_regs(
        ...
        .raddr3_i(id_reg3_raddr_o), // Custom Instruction -LOAD MAC
        .rdata2_o(regs_rdata2_o),
        .rdata3_o(regs_rdata3_o), // Custom Instruction -LOAD MAC
    ...
    id u_id(
        ...
        .reg3_rdata_i(regs_rdata3_o), // Custom Instruction -LOAD MAC
        .ex_jump_flag_i(ex_jump_flag_o),
        .reg1_raddr_o(id_reg1_raddr_o),
        .reg2_raddr_o(id_reg2_raddr_o),
        .reg3_raddr_o(id_reg3_raddr_o), // Custom Instruction -LOAD MAC
        .inst_o(id_inst_o),
        .inst_addr_o(id_inst_addr_o),
        .reg1_rdata_o(id_reg1_rdata_o),
        .reg2_rdata_o(id_reg2_rdata_o),
        .reg3_rdata_o(id_reg3_rdata_o), // Custom Instruction -LOAD MAC
    ...
    id_ex u_id_ex(
        ...
        .reg3_rdata_i(id_reg3_rdata_o),  // Custom Instruction -LOAD MAC
        .hold_flag_i(ctrl_hold_flag_o),
        .inst_o(ie_inst_o),
    ...
    ex u_ex(
        ...
        .op1_i(ie_op1_o),
        .op2_i(ie_op2_o),
        .mac_acc_out(macl_acc_out), // Custom Instruction -LOAD MAC
        .mac_load_done(mac_load_done), // Custom Instruction -LOAD MAC
        .mac_load_busy(mac_load_busy), // Custom Instruction -LOAD MAC
        .mac_reg_waddr_i(macl_reg_waddr_o), // Custom Instruction -LOAD MAC
