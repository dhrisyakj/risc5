...
module id(
    ...
    output reg[`RegAddrBus] reg3_raddr_o, // Custom Instruction -LOAD_MAC
    // to csr reg
    ...
    output reg[`RegBus] reg3_rdata_o, // Custom Instruction -LOAD_MAC
              ...
              case (funct3)
                    `INST_ADDTT: begin
                       ...
                       `INST_MACL: begin     // Custom Instruction -MACL
                         ...
                         `INST_LOADM: begin     // Custom Instruction --LOAD_MAC
                         reg_we_o = `WriteDisable;
                           reg_waddr_o = rd;
                            reg1_raddr_o = rs1;
                            reg2_raddr_o = rs2;
