...
module ex(
   ...
   //input wire is_mac_done_i,
    ...
    // from LOAD_MAC module
     input wire[`RegBus] mac_acc_out,  // Custom Instruction -LOAD_MAC
     
      // from LOAD_MAC module
    input wire mac_load_done, // Custom Instruction -LOAD_MAC
    input wire mac_load_busy, // Custom Instruction -LOAD_MAC
    input wire[`RegAddrBus] mac_reg_waddr_i, // Custom Instruction -LOAD_MAC
    ...
    //wire [`RegAddrBus] mac_reg_addr; 
     ...
     // Custom Instruction -LOAD_MAC
   reg mac_hold;
   reg mac_jump_flag;
   reg[`InstAddrBus] mac_jump_addr;
   reg mac_we;
