...
HD_PWD='/home/sidharth/Vivado_Projects/MAC/MAC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_128.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mac_128.tcl
