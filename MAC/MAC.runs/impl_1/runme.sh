...
HD_PWD='/home/sidharth/Vivado_Projects/MAC/MAC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_128.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mac_128.tcl -notrace
